...
| ADR-0005 | Register the app icon at runtime and embed it in the Windows `.exe`, defer packaging to M5 | Accepted |
| ADR-0006 | Defer the macOS Dock icon until gpui exposes a runtime icon API | Accepted |
