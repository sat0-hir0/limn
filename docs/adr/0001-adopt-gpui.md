...
**We adopt gpui (Zed's GUI framework).**

gpui is a framework developed as the GUI foundation of the Zed editor — a
Rust-native UI library centred on GPU rendering. Zed itself demonstrates
gpui's capability by achieving world-class text-editor rendering performance.
...
- We implement the editor on the same technical foundation and with the same
  writing feel as Zed
...
- IME support benefits from the same pipeline Zed uses
...
- **Small community** — very few gpui users outside the Zed team. Documentation,
  examples, and community Q&A are limited
...
- Following Zed's development makes it easier to benefit from new features
...
- **Summary**: Proven by projects such as Obsidian. The richest web technology
  ecosystem.
...
- [gpui repository (Zed)](https://github.com/zed-industries/zed/tree/main/crates/gpui)
