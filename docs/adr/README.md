...
| [ADR-0005](0005-app-icon-runtime-and-embed.md) | Register the app icon at runtime and embed it in the Windows `.exe`, defer packaging to M5 | Proposed | 2026-06-25 |
| [ADR-0006](0006-defer-runtime-icon-macos-windows.md) | Defer runtime title-bar and Dock icon on macOS and Windows until gpui exposes an icon surface | Proposed | 2026-06-25 |
